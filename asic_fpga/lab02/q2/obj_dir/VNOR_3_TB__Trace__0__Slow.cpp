...
VL_ATTR_COLD void VNOR_3_TB___024root__trace_init_sub__TOP__0(VNOR_3_TB___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VNOR_3_TB__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VNOR_3_TB___024root__trace_init_sub__TOP__0\n"); );
    // Init
    const int c = vlSymsp->__Vm_baseCode;
    // Body
    tracep->pushPrefix("NOR_3_TB", VerilatedTracePrefixType::SCOPE_MODULE);
...
VL_ATTR_COLD void VNOR_3_TB___024root__trace_init_top(VNOR_3_TB___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VNOR_3_TB__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VNOR_3_TB___024root__trace_init_top\n"); );
    // Body
    VNOR_3_TB___024root__trace_init_sub__TOP__0(vlSelf, tracep);
}

VL_ATTR_COLD void VNOR_3_TB___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
VL_ATTR_COLD void VNOR_3_TB___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
...
VL_ATTR_COLD void VNOR_3_TB___024root__trace_register(VNOR_3_TB___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VNOR_3_TB__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VNOR_3_TB___024root__trace_register\n"); );
    // Body
    tracep->addConstCb(&VNOR_3_TB___024root__trace_const_0, 0U, vlSelf);
    tracep->addFullCb(&VNOR_3_TB___024root__trace_full_0, 0U, vlSelf);
    tracep->addChgCb(&VNOR_3_TB___024root__trace_chg_0, 0U, vlSelf);
    tracep->addCleanupCb(&VNOR_3_TB___024root__trace_cleanup, vlSelf);
}

VL_ATTR_COLD void VNOR_3_TB___024root__trace_const_0_sub_0(VNOR_3_TB___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void VNOR_3_TB___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VNOR_3_TB___024root__trace_const_0\n"); );
    // Init
    VNOR_3_TB___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VNOR_3_TB___024root*>(voidSelf);
    VNOR_3_TB__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    VNOR_3_TB___024root__trace_const_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void VNOR_3_TB___024root__trace_const_0_sub_0(VNOR_3_TB___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    VNOR_3_TB__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VNOR_3_TB___024root__trace_const_0_sub_0\n"); );
    // Init
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode);
    // Body
    bufp->fullCData(oldp+6,(1U),8);
}

VL_ATTR_COLD void VNOR_3_TB___024root__trace_full_0_sub_0(VNOR_3_TB___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void VNOR_3_TB___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VNOR_3_TB___024root__trace_full_0\n"); );
    // Init
    VNOR_3_TB___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VNOR_3_TB___024root*>(voidSelf);
    VNOR_3_TB__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    VNOR_3_TB___024root__trace_full_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void VNOR_3_TB___024root__trace_full_0_sub_0(VNOR_3_TB___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    VNOR_3_TB__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VNOR_3_TB___024root__trace_full_0_sub_0\n"); );
    // Init
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode);
    // Body
    bufp->fullBit(oldp+1,(vlSelf->NOR_3_TB__DOT__A0));
    bufp->fullBit(oldp+2,(vlSelf->NOR_3_TB__DOT__A1));
    bufp->fullBit(oldp+3,(vlSelf->NOR_3_TB__DOT__A2));
    bufp->fullBit(oldp+4,(vlSelf->NOR_3_TB__DOT__OUT));
    bufp->fullBit(oldp+5,(vlSelf->NOR_3_TB__DOT__UUT__DOT__OR_0_INST__DOT__tmp));
}
